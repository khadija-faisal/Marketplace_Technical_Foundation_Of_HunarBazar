        ...
        <div className="bg-gray-100">
          <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
            ...
            <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
              <Link aria-label="facebook-profile" href={"/https://www.facebook.com/profile.php?id=100073361696418"} className="ml-3 text-gray-800">
                <svg
                  fill="currentColor"
                  strokeLinecap="round"
              ...
              <Link aria-label="Instagram-profile" href={"/https://www.instagram.com/doll.alyana/"} className="ml-3 text-gray-800">
                <svg
                  fill="none"
                  stroke="currentColor"
                  strokeLinecap="round"
              ...
              <Link aria-label="LinkedIn-profile" href={"/https://www.linkedin.com/in/khadijamughal19/"} className="ml-3 text-gray-800">
                <svg
                  fill="currentColor"
                  stroke="currentColor"
                  strokeLinecap="round"
