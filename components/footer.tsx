...
const Footer = () => {
  return (
    <div><footer className="text-gray-600 font-montserrat ">
      ...
      <div className="flex flex-wrap md:text-left text-center order-first">
        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
          ...
          <nav className="list-none flex items-center md:items-start flex-col gap-3 mb-10">
            ...
            <MapPin className='h-10' />
              <span>Sapphire Retail Head Office
              1.5-Km, Defence Road, Bhobtian Chowk, Off Raiwind Road, Opposite University of Lahore, Lahore.</span>
            </li>
        ...
        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
          ...
          <nav className="list-none flex flex-col gap-4 mb-10">
            <li>
              <Link href={'/'} className="text-gray-600 hover:text-gray-800">Exchange & Return Policy</Link>
            </li>
            <li>
        ...
        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
          ...
          <nav className="list-none flex flex-col gap-4 mb-10">
            ...
            <li>
              <Link href={'/'}  className="text-gray-600 hover:text-gray-800">SafePay Guide</Link>
            </li>
            <li>
